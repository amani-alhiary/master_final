...
<div class="col-md-6 " style="margin-left: 30%">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" action="{{route('booksuser.update', $book[0]->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 ">
                        <input class="form-control" rows="3" placeholder="" name="quote" value="{{ $book[0]->quote }}">
                    </div>
                </div>
                @error('quote')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-sm-9 ">
                        <input class="form-control" rows="3" placeholder="" name="description" value="{{ $book[0]->description }}">
                    </div>
                </div>
