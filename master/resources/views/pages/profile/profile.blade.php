	...
	<div class="container">
      ...
      <div class="gallery-item-info">
        ...
        <ul>
          ...
          <a href="{{ url('editprofilebook?id=' . Auth::user()->id) }}"> <button class="btn profile-edit-btn">Edit Book</button></a>

          <form action="{{ route('booksuser.destroy',$book->id) }}" method="Post">
        @csrf
        @method('DELETE')
        <td class=" last"><a href="#"><button type="submit" class="btn profile-edit-btn"  onclick="return confirm('Are you sure?');"> <i class="fa fa-trash-o"></i>Delete</button></a>
        </td>
      </form>
        </ul>
