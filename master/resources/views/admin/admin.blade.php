        ...
        <div class="row" style="display: inline-block;">
            <div class="tile_count">
                ...
                <div class="col-md-2 col-sm-4  tile_stats_count">
                    ...
                    <div class="count">{{ $sold_books_avg }}</div>
                    <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{ ($total_sold_books/$total_books)*100 }}% </i> From last Week</span>
                </div>
                <div class="col-md-2 col-sm-4  tile_stats_count">
